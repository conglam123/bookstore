...
public class NguoiDungDAL extends SqlDataConnection{
    private final String INSERT = "insert into tb_NguoiDung(taiKhoan,matKhau,quyenTruyCap,tenNguoiDung,email) values(?,?,?,?,?)";
...
//        System.out.println(GET_ALL);
    ...
    public boolean insertData(NguoiDung data) {
        ...
        try {
            ...
            ps.setString(4, data.getTenNguoiDung());
            ps.setInt(3, data.getQuyenTruyCap());
