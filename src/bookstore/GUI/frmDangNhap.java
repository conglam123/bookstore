...
public class frmDangNhap extends javax.swing.JFrame {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtTaiKhoan, javax.swing.GroupLayout.DEFAULT_SIZE, 216, Short.MAX_VALUE)
    ...
    void checkLogin() {
        ...
        if (obj.getLogin(u, p)) {
            ArrayList<NguoiDung> dn = new ArrayList<>();
            dn = obj.getLoginData(u, p);
            taiKhoan = dn.get(0).getTaiKhoan();
            tenNguoiDung = dn.get(0).getTenNguoiDung();
            System.out.println(obj.getLoginData(u, p));
            JOptionPane.showMessageDialog(this, "Xin chào " + tenNguoiDung + "!");
            
            if(dn.get(0).getQuyenTruyCap() == 0){
